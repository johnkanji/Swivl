...
extension BLAS {
  ...
  public static func negate<T>(_ a: [T]) -> [T] where T: AccelerateFloatingPoint {
  ...
  public static func abs<T>(_ a: [T]) -> [T] where T: AccelerateNumeric {
  ...
  public static func max<T>(_ a: [T]) -> (value: T, index: Int) where T: AccelerateFloatingPoint {
    let n = vDSP_Length(a.count)
  ...
  public static func min<T>(_ a: [T]) -> (value: T, index: Int) where T: AccelerateFloatingPoint {
    let n = vDSP_Length(a.count)
    var ci = vDSP_Length(0)
    if T.self is Double.Type {
      var c: Double = 0
  ...
  public static func sum<T>(_ a: [T]) -> T where T: AccelerateFloatingPoint {
    if T.self is Double.Type {
  ...
  public static func mean<T>(_ a: [T]) -> T where T: AccelerateFloatingPoint {
    if T.self is Double.Type {
  ...
  public static func square<T>(_ a: [T]) -> [T] where T: AccelerateFloatingPoint {
    if T.self is Double.Type {
